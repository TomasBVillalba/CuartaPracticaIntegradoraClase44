...
const user = {
    first_name: "Tomas",
    last_name: "Villalba",
    email: "tomasbautistavillalba@gmail.com",
    password: "1234"
}
...
describe("Pruebas con supertest", () => {
    ...
    before(async function() {
        await mongoose.connect("mongodb+srv://tomasbautistavillalba:longboard1889RC@cluster1.nhyjdqz.mongodb.net/ecommerce?retryWrites=true&w=majority");
